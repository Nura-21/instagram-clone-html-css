...
<head>
    ...
    <title>Instagram - Новая публикация</title>
</head>
<body>
<header class="header">
...
<main class="main flex align-center justify-center">
    <section class="post border">
        <div class="post-header flex align-center justify-center"><span><b>Создание публикации</b></span></div>
        <div class="post-content flex col align-center justify-center">
            <svg aria-label="Значок, соответствующий медиафайлам, например изображениям или видео" class="_ab6-"
            ...
            <span style="font-size: 22px; margin-bottom: 26px; color: rgb(38, 38, 38)">Перетащите сюда фото и видео</span>
