...
// parsing url to get recommended user

$query_string = $_SERVER['QUERY_STRING'];
$recommended_user_id = substr($query_string, strpos($query_string, "=") + 1);
$recommended_user_id = intval($recommended_user_id);

$recommended_user = getUserData($link, $recommended_user_id);
$recommended_user_description = $recommended_user['description'];
$recommended_user_avatar = $recommended_user['avatar'];
$recommended_user_name = $recommended_user['user_name'];
$posts = getUserPosts($link, $recommended_user_id);
...
<head>
    ...
    <title>Instagram - <?php echo $recommended_user_name ?></title>
</head>
<body>
<header class="header">
        ...
        <div class="profile-header flex row align-center">
            <div class="profile-logo flex justify-center img">
                <?php echo '<div class="profile-logo flex justify-center img" >
                    <img src="data:image/jpeg;base64,' . base64_encode($recommended_user_avatar) . '" style="height: 150px; width: 150px;"/>      
              </div>' ?>
            </div>
            <div class="profile-info flex col justify-between">
                <div class="profile-login flex row align-center">
                    <span><?php echo $recommended_user_name ?></span>
                </div>
                <div class="profile-stats flex row">
                    <span><b><?php echo getPostCnt($link, $recommended_user_id)?></b> публикаций</span>
                    <span><b><?php echo getFollowingsCnt($link, $recommended_user_id)?></b> подписчиков</span>
                    <span><b><?php echo getFollowersCnt($link, $recommended_user_id)?></b> подписок</span>
                </div>
                <div class="profile-desc flex col">
                    <span><?php echo $recommended_user_description ?></span>
                </div>
            </div>
        </div>
